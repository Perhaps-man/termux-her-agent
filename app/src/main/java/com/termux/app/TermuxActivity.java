...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    private void notifyHerReadyOnce() {
        if (sHerReadySent.compareAndSet(false, true)) {
            try {
                sendBroadcast(new Intent(HER_TERMUX_READY));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("special".equals(mode)) {
            findViewById(R.id.terminal_black_mask).setVisibility(View.GONE);
        }
        lastInstance = this;
