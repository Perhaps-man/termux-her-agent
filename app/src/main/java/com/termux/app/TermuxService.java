...
import static com.termux.app.HerApp.appContext;
...
public final class TermuxService extends Service implements TermuxTask.TermuxTaskClient, TermuxSession.TermuxSessionClient {
    // ★★ 直接贴进 TermuxService.java 里即可 ★★
    // 放在 TermuxService 里
    /** 执行任意命令（单次），流式逐行回调输出，基于你刚加的 SessionOutputListener。 */

    // TermuxService.java 里新增：
    ...
    public static TermuxService instance;
    ...
    public static TermuxService get(){
        return instance;
    }
